...
-- Step 2: Add primary key to inventory table
ALTER TABLE dbo.Formatted_Company_Inventory
...
-- Step 3: Create table to track loaner checkouts
...
-- Step 5: Create view for available loaners
...
-- Step 6: Create view for checked out loaners
